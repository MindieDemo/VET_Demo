                ...
                <div >
                                <center>
                                   ...
                                   <!--  <p id="desc">
                                    ...
                                    <img 
                                    src="img/lympnode/popliteal.png" alt="LymphNode" usemap="#fullbodymap"/>
                                  
                    <map name="fullbodymap">
                                    <area 
                                    target="_blank" 
                                    alt="" 
                                    title=""   
                                    coords="308,154,290,141" 
                                    onclick= "writeHeader('Supramammary(F)')"
                                    shape="rect"/>

                                    <area alt="" title=""  
                                    onclick="writeHeader('Precrural')"
                                    coords="328,83,347,99" shape="rect"/>

                                    <area alt="" title=""                           
                                    onclick="writeHeader('Internal illiac')"
                                     coords="350,103,366,119" shape="rect" />

                                    <area alt="" title="" href="#" 
                                    shape="rect" 
                                    onclick="writeHeader('Sublumbar')"
                                    coords="379,87,393,107"  />
                                 
                                 
                                    <area alt="" title="" href="#" 
                                    shape="rect" 
                                    onclick="writeHeader('Renal')"
                                    coords="494,84,514,104" />
                                    
                                    <area alt="" title="" href="#" 
                                    shape="rect" 
                                    onclick="writeHeader('Prepectoral')"
                                    coords="778,190,799,205" />

                                    
                                    <area alt="" title="" href="#" 
                                    shape="rect" 
                                    onclick="writeHeader('Retrophayngeal')"
                                    coords="906,148,927,171" />
                                    
                                    
                                    <area alt="" title="" href="#" 
                                    shape="rect" 
                                    onclick="writeHeader('Submaxilary')"
                                    coords="939,131,967,156"  />
